...
export declare class TCollection_ExtendedString {
   ...
   * @param theString the char16_t string to copy
   */
   ...
   */
  AssignCat(theStringView: any): void;
  /**
   ...
   * @param theLiteral the string literal or char16_t array to append
   */
   ...
   * @param theOther the string to move from
   */
  Move(theOther: TCollection_ExtendedString): void;
  /**
   * Exchange the data of two strings (without reallocating memory).
   * @param theOther the string to exchange data with
   */
   ...
   * @param theWhere the position to insert at (1-based)
   * @param theWhat the string to insert
   */
   ...
   * @param theWhere the position to start replacement (1-based)
   * @param theWhat the string to replace with
   */
...
export declare class gp_Circ2d {
   ...
   * theAxis defines the Xaxis and Yaxis of the circle which defines the origin and the sense of parametrization. The location point of theAxis is the center of the circle. Warnings: It is not forbidden to create a circle with theRadius = 0.0 Raises ConstructionError if theRadius < 0.0.
   */
  constructor(theXAxis: gp_Ax2d, theRadius: number);
  /**
...
export declare class Poly_PolygonOnTriangulation extends Standard_Transient {
   ...
   */
  SetParameters(theParameters: TColStd_HArray1OfReal): void;
  /**
...
export declare class Poly_Triangulation extends Standard_Transient {
   ...
   * Constructs a triangulation from a set of triangles. The triangulation is initialized with 3D points from Nodes, 2D points from UVNodes and triangles from Triangles, where coordinates of a 2D point from UVNodes are the (u, v) parameters of the corresponding 3D point from Nodes on the surface approximated by the constructed triangulation.
   */
  constructor(theNbNodes: number, theNbTriangles: number, theHasUVNodes: boolean);
  /**
   ...
   * @param theIndex node index within [1, NbNodes()] range
   * @param theVec3 normalized 3D vector defining a surface normal
   */
   ...
   */
  MapNodeArray(): TColgp_HArray1OfPnt;
  /**
   ...
   */
  MapTriangleArray(): Poly_HArray1OfTriangle;
  /**
   ...
   */
  MapUVNodeArray(): TColgp_HArray1OfPnt2d;
  /**
   ...
   */
  InternalNormals(): [number, number, number];
  SetNormals(theNormals: number): void;
...
export declare class GeomToolsWrapper {
  constructor();
  static Write(geometry: Geom2d_Curve): any;
  static Read(data: any): Geom2d_Curve;
  /** Releases the C++ object. The caller must ensure no further access. */
  delete(): void;
  [Symbol.dispose](): void;
}
...
export declare class BRepToolsWrapper {
  constructor();
  static Write(shape: TopoDS_Shape): any;
  static Read(data: any): TopoDS_Shape;
  /** Releases the C++ object. The caller must ensure no further access. */
  delete(): void;
  [Symbol.dispose](): void;
}
...
export declare class BRepAlgoAPI_Section extends BRepAlgoAPI_BooleanOperation {
   ...
   * Empty constructor.
   */
  constructor(S1: TopoDS_Shape, Sf: Geom_Surface);
  /**
   * Empty constructor.
   */
  constructor(Sf: Geom_Surface, S2: TopoDS_Shape);
  /**
   * Empty constructor.
   */
  constructor(Sf1: Geom_Surface, Sf2: Geom_Surface);
  /**
...
export declare class Law_Interpol extends Law_BSpFunc {
   ...
   */
  Set(ParAndRad: TColgp_Array1OfPnt2d, Periodic: boolean): void;
  /**
   ...
   */
  Set(ParAndRad: TColgp_Array1OfPnt2d, Dd: number, Df: number, Periodic: boolean): void;
  SetInRelative(ParAndRad: TColgp_Array1OfPnt2d, Ud: number, Uf: number, Periodic: boolean): void;
  SetInRelative(ParAndRad: TColgp_Array1OfPnt2d, Ud: number, Uf: number, Dd: number, Df: number, Periodic: boolean): void;
  static get_type_name(): string;
  static get_type_descriptor(): Standard_Type;
  DynamicType(): Standard_Type;
  /** Releases the C++ object. The caller must ensure no further access. */
...
export declare class Geom2dAPI_InterCurveCurve {
   ...
   * Creates an object and computes self-intersections of the curve C1. Tolerance value Tol, defaulted to 1.0e-6, defines the precision of computing the intersection points. In case of a tangential intersection, Tol also defines the size of intersection segments (limited portions of the curves) where the distance between all points from two curves (or a curve in case of self-intersection) is less than Tol. Warning Use functions NbPoints and NbSegments to obtain the number of solutions. If the algorithm finds no intersections NbPoints and NbSegments return 0.
   */
  constructor(C1: Geom2d_Curve, C2: Geom2d_Curve);
  /**
...
export declare class Geom2dAPI_PointsToBSpline {
   ...
   * Constructs an empty approximation algorithm. Use an Init function to define and build the BSpline curve.
   */
  constructor(Points: TColgp_Array1OfPnt2d);
  /**
   * Constructs an empty approximation algorithm. Use an Init function to define and build the BSpline curve.
   */
  constructor(Points: TColgp_Array1OfPnt2d, DegMin: number);
  /**
   * Constructs an empty approximation algorithm. Use an Init function to define and build the BSpline curve.
   */
  constructor(Points: TColgp_Array1OfPnt2d, ParType: Approx_ParametrizationType);
  /**
   * Constructs an empty approximation algorithm. Use an Init function to define and build the BSpline curve.
   */
  constructor(Points: TColgp_Array1OfPnt2d, Parameters: TColStd_Array1OfReal);
  /**
   * Constructs an empty approximation algorithm. Use an Init function to define and build the BSpline curve.
   */
  constructor(Points: TColgp_Array1OfPnt2d, DegMin: number, DegMax: number);
  /**
   * Constructs an empty approximation algorithm. Use an Init function to define and build the BSpline curve.
   */
  constructor(YValues: TColStd_Array1OfReal, X0: number, DX: number);
  /**
   * Constructs an empty approximation algorithm. Use an Init function to define and build the BSpline curve.
   */
  constructor(Points: TColgp_Array1OfPnt2d, ParType: Approx_ParametrizationType, DegMin: number);
  /**
   * Constructs an empty approximation algorithm. Use an Init function to define and build the BSpline curve.
   */
  constructor(Points: TColgp_Array1OfPnt2d, Parameters: TColStd_Array1OfReal, DegMin: number);
  /**
   * Constructs an empty approximation algorithm. Use an Init function to define and build the BSpline curve.
   */
  constructor(Points: TColgp_Array1OfPnt2d, DegMin: number, DegMax: number, Continuity: GeomAbs_Shape);
  /**
   * Constructs an empty approximation algorithm. Use an Init function to define and build the BSpline curve.
   */
  constructor(YValues: TColStd_Array1OfReal, X0: number, DX: number, DegMin: number);
  /**
   * Constructs an empty approximation algorithm. Use an Init function to define and build the BSpline curve.
   */
  constructor(Points: TColgp_Array1OfPnt2d, Weight1: number, Weight2: number, Weight3: number);
  /**
   * Constructs an empty approximation algorithm. Use an Init function to define and build the BSpline curve.
   */
  constructor(Points: TColgp_Array1OfPnt2d, ParType: Approx_ParametrizationType, DegMin: number, DegMax: number);
  /**
   * Constructs an empty approximation algorithm. Use an Init function to define and build the BSpline curve.
   */
  constructor(Points: TColgp_Array1OfPnt2d, Parameters: TColStd_Array1OfReal, DegMin: number, DegMax: number);
  /**
   ...
   * Approximate a BSpline Curve passing through an array of Point. The resulting BSpline will have the following properties: 1- his degree will be in the range [Degmin,Degmax] 2- his continuity will be at least <Continuity> 3- the distance from the point <Points> to the BSpline will be lower to Tol2D.
   */
  constructor(YValues: TColStd_Array1OfReal, X0: number, DX: number, DegMin: number, DegMax: number);
  /**
   * Approximate a BSpline Curve passing through an array of Point. The resulting BSpline will have the following properties: 1- his degree will be in the range [Degmin,Degmax] 2- his continuity will be at least <Continuity> 3- the distance from the point <Points> to the BSpline will be lower to Tol2D.
   */
  constructor(Points: TColgp_Array1OfPnt2d, Weight1: number, Weight2: number, Weight3: number, DegMax: number);
  /**
   * Approximate a BSpline Curve passing through an array of Point. The resulting BSpline will have the following properties: 1- his degree will be in the range [Degmin,Degmax] 2- his continuity will be at least <Continuity> 3- the distance from the point <Points> to the BSpline will be lower to Tol2D.
   */
  constructor(Points: TColgp_Array1OfPnt2d, ParType: Approx_ParametrizationType, DegMin: number, DegMax: number, Continuity: GeomAbs_Shape);
  /**
   * Approximate a BSpline Curve passing through an array of Point. The resulting BSpline will have the following properties: 1- his degree will be in the range [Degmin,Degmax] 2- his continuity will be at least <Continuity> 3- the distance from the point <Points> to the BSpline will be lower to Tol2D.
   */
  constructor(Points: TColgp_Array1OfPnt2d, Parameters: TColStd_Array1OfReal, DegMin: number, DegMax: number, Continuity: GeomAbs_Shape);
  /**
   * Approximate a BSpline Curve passing through an array of Point. The resulting BSpline will have the following properties: 1- his degree will be in the range [Degmin,Degmax] 2- his continuity will be at least <Continuity> 3- the distance from the point <Points> to the BSpline will be lower to Tol2D.
   */
   ...
   * Approximate a BSpline Curve passing through an array of Point. The resulting BSpline will have the following properties: 1- his degree will be in the range [Degmin,Degmax] 2- his continuity will be at least <Continuity> 3- the distance from the point <Points> to the BSpline will be lower to Tol2D.
   */
  constructor(YValues: TColStd_Array1OfReal, X0: number, DX: number, DegMin: number, DegMax: number, Continuity: GeomAbs_Shape);
  /**
   * Approximate a BSpline Curve passing through an array of Point. The resulting BSpline will have the following properties: 1- his degree will be in the range [Degmin,Degmax] 2- his continuity will be at least <Continuity> 3- the distance from the point <Points> to the BSpline will be lower to Tol2D.
   */
  constructor(Points: TColgp_Array1OfPnt2d, Weight1: number, Weight2: number, Weight3: number, DegMax: number, Continuity: GeomAbs_Shape);
  /**
   ...
   * Approximate a BSpline Curve passing through an array of Point. The resulting BSpline will have the following properties: 1- his degree will be in the range [Degmin,Degmax] 2- his continuity will be at least <Continuity> 3- the distance from the point <Points> to the BSpline will be lower to Tol2D.
   */
  Init(Points: TColgp_Array1OfPnt2d, DegMin: number, DegMax: number, Continuity: GeomAbs_Shape, Tol2D: number): void;
  /**
   * Approximate a BSpline Curve passing through an array of Point. The resulting BSpline will have the following properties: 1- his degree will be in the range [Degmin,Degmax] 2- his continuity will be at least <Continuity> 3- the distance from the point <Points> to the BSpline will be lower to Tol2D.
   */
  Init(Points: TColgp_Array1OfPnt2d, ParType: Approx_ParametrizationType, DegMin: number, DegMax: number, Continuity: GeomAbs_Shape, Tol2D: number): void;
  /**
   ...
   */
  Init(Points: TColgp_Array1OfPnt2d, Parameters: TColStd_Array1OfReal, DegMin: number, DegMax: number, Continuity: GeomAbs_Shape, Tol2D: number): void;
  /**
   * Approximate a BSpline Curve passing through an array of Point. Of coordinates :
   */
  Init(YValues: TColStd_Array1OfReal, X0: number, DX: number, DegMin: number, DegMax: number, Continuity: GeomAbs_Shape, Tol2D: number): void;
  /**
   ...
   */
  Init(Points: TColgp_Array1OfPnt2d, Weight1: number, Weight2: number, Weight3: number, DegMax: number, Continuity: GeomAbs_Shape, Tol2D: number): void;
  /**
...
export declare class GeomAPI_PointsToBSpline {
   ...
   * Constructs an empty approximation algorithm. Use an Init function to define and build the BSpline curve.
   */
  constructor(Points: TColgp_Array1OfPnt);
  /**
   * Constructs an empty approximation algorithm. Use an Init function to define and build the BSpline curve.
   */
  constructor(Points: TColgp_Array1OfPnt, DegMin: number);
  /**
   * Constructs an empty approximation algorithm. Use an Init function to define and build the BSpline curve.
   */
  constructor(Points: TColgp_Array1OfPnt, ParType: Approx_ParametrizationType);
  /**
   * Constructs an empty approximation algorithm. Use an Init function to define and build the BSpline curve.
   */
  constructor(Points: TColgp_Array1OfPnt, Parameters: TColStd_Array1OfReal);
  /**
   * Constructs an empty approximation algorithm. Use an Init function to define and build the BSpline curve.
   */
  constructor(Points: TColgp_Array1OfPnt, DegMin: number, DegMax: number);
  /**
   * Constructs an empty approximation algorithm. Use an Init function to define and build the BSpline curve.
   */
  constructor(Points: TColgp_Array1OfPnt, ParType: Approx_ParametrizationType, DegMin: number);
  /**
   * Constructs an empty approximation algorithm. Use an Init function to define and build the BSpline curve.
   */
  constructor(Points: TColgp_Array1OfPnt, Parameters: TColStd_Array1OfReal, DegMin: number);
  /**
   * Constructs an empty approximation algorithm. Use an Init function to define and build the BSpline curve.
   */
  constructor(Points: TColgp_Array1OfPnt, DegMin: number, DegMax: number, Continuity: GeomAbs_Shape);
  /**
   * Constructs an empty approximation algorithm. Use an Init function to define and build the BSpline curve.
   */
  constructor(Points: TColgp_Array1OfPnt, ParType: Approx_ParametrizationType, DegMin: number, DegMax: number);
  /**
   * Constructs an empty approximation algorithm. Use an Init function to define and build the BSpline curve.
   */
  constructor(Points: TColgp_Array1OfPnt, Parameters: TColStd_Array1OfReal, DegMin: number, DegMax: number);
  /**
   * Constructs an empty approximation algorithm. Use an Init function to define and build the BSpline curve.
   */
  constructor(Points: TColgp_Array1OfPnt, Weight1: number, Weight2: number, Weight3: number);
  /**
   ...
   * Approximate a BSpline Curve passing through an array of Point. The resulting BSpline will have the following properties: 1- his degree will be in the range [Degmin,Degmax] 2- his continuity will be at least <Continuity> 3- the distance from the point <Points> to the BSpline will be lower to Tol3D.
   */
  constructor(Points: TColgp_Array1OfPnt, ParType: Approx_ParametrizationType, DegMin: number, DegMax: number, Continuity: GeomAbs_Shape);
  /**
   * Approximate a BSpline Curve passing through an array of Point. The resulting BSpline will have the following properties: 1- his degree will be in the range [Degmin,Degmax] 2- his continuity will be at least <Continuity> 3- the distance from the point <Points> to the BSpline will be lower to Tol3D.
   */
  constructor(Points: TColgp_Array1OfPnt, Parameters: TColStd_Array1OfReal, DegMin: number, DegMax: number, Continuity: GeomAbs_Shape);
  /**
   * Approximate a BSpline Curve passing through an array of Point. The resulting BSpline will have the following properties: 1- his degree will be in the range [Degmin,Degmax] 2- his continuity will be at least <Continuity> 3- the distance from the point <Points> to the BSpline will be lower to Tol3D.
   */
  constructor(Points: TColgp_Array1OfPnt, Weight1: number, Weight2: number, Weight3: number, DegMax: number);
  /**
   * Approximate a BSpline Curve passing through an array of Point. The resulting BSpline will have the following properties: 1- his degree will be in the range [Degmin,Degmax] 2- his continuity will be at least <Continuity> 3- the distance from the point <Points> to the BSpline will be lower to Tol3D.
   */
   ...
   * Approximate a BSpline Curve passing through an array of Point. The resulting BSpline will have the following properties: 1- his degree will be in the range [Degmin,Degmax] 2- his continuity will be at least <Continuity> 3- the distance from the point <Points> to the BSpline will be lower to Tol3D.
   */
  constructor(Points: TColgp_Array1OfPnt, Weight1: number, Weight2: number, Weight3: number, DegMax: number, Continuity: GeomAbs_Shape);
  /**
   * Approximate a BSpline Curve passing through an array of Point using variational smoothing algorithm, which tries to minimize additional criterium: Weight1*CurveLength + Weight2*Curvature + Weight3*Torsion.
   */
   ...
   * Approximate a BSpline Curve passing through an array of Point. The resulting BSpline will have the following properties: 1- his degree will be in the range [Degmin,Degmax] 2- his continuity will be at least <Continuity> 3- the distance from the point <Points> to the BSpline will be lower to Tol3D.
   */
  Init(Points: TColgp_Array1OfPnt, DegMin: number, DegMax: number, Continuity: GeomAbs_Shape, Tol3D: number): void;
  /**
   * Approximate a BSpline Curve passing through an array of Point. The resulting BSpline will have the following properties: 1- his degree will be in the range [Degmin,Degmax] 2- his continuity will be at least <Continuity> 3- the distance from the point <Points> to the BSpline will be lower to Tol3D.
   */
  Init(Points: TColgp_Array1OfPnt, ParType: Approx_ParametrizationType, DegMin: number, DegMax: number, Continuity: GeomAbs_Shape, Tol3D: number): void;
  /**
   * Approximate a BSpline Curve passing through an array of Point, which parameters are given by the array <Parameters>. The resulting BSpline will have the following properties: 1- his degree will be in the range [Degmin,Degmax] 2- his continuity will be at least <Continuity> 3- the distance from the point <Points> to the BSpline will be lower to Tol3D.
   */
  Init(Points: TColgp_Array1OfPnt, Parameters: TColStd_Array1OfReal, DegMin: number, DegMax: number, Continuity: GeomAbs_Shape, Tol3D: number): void;
  /**
   * Approximate a BSpline Curve passing through an array of Point using variational smoothing algorithm, which tries to minimize additional criterium: Weight1*CurveLength + Weight2*Curvature + Weight3*Torsion.
   */
  Init(Points: TColgp_Array1OfPnt, Weight1: number, Weight2: number, Weight3: number, DegMax: number, Continuity: GeomAbs_Shape, Tol3D: number): void;
  /**
...
export declare class BRepPrimAPI_MakePrism extends BRepPrimAPI_MakeSweep {
   ...
   * Builds the prism of base S and vector V. If C is true, S is copied. If Canonize is true then generated surfaces are attempted to be canonized in simple types.
   */
  constructor(S: TopoDS_Shape, D: gp_Dir);
  /**
   * Builds the prism of base S and vector V. If C is true, S is copied. If Canonize is true then generated surfaces are attempted to be canonized in simple types.
   */
  constructor(S: TopoDS_Shape, V: gp_Vec, Copy: boolean);
  /**
   * Builds the prism of base S and vector V. If C is true, S is copied. If Canonize is true then generated surfaces are attempted to be canonized in simple types.
   */
  constructor(S: TopoDS_Shape, D: gp_Dir, Inf: boolean);
  /**
   * Builds the prism of base S and vector V. If C is true, S is copied. If Canonize is true then generated surfaces are attempted to be canonized in simple types.
   */
   ...
   * Builds the prism of base S and vector V. If C is true, S is copied. If Canonize is true then generated surfaces are attempted to be canonized in simple types.
   */
  constructor(S: TopoDS_Shape, D: gp_Dir, Inf: boolean, Copy: boolean);
  /**
...
export declare class BRepPrimAPI_MakeRevol extends BRepPrimAPI_MakeSweep {
   ...
   */
  constructor(S: TopoDS_Shape, A: gp_Ax1);
  /**
   ...
   * Builds the Revol of base S, axis A and angle 2*Pi. If C is true, S is copied.
   */
  constructor(S: TopoDS_Shape, A: gp_Ax1, D: number);
  /**
   * Builds the Revol of base S, axis A and angle D. If C is true, S is copied.
   */
...
export declare class HLRBRep_InternalAlgo extends Standard_Transient {
  ...
  SeqOfShapeBounds(): HLRBRep_ShapeBounds;
  NbShapes(): number;
...
export declare class BRepOffsetAPI_MakeOffset extends BRepBuilderAPI_MakeShape {
   ...
   * Constructs an algorithm for creating an empty offset.
   */
  constructor(Spine: TopoDS_Face, Join: GeomAbs_JoinType);
  /**
   * Constructs an algorithm for creating an empty offset.
   */
  constructor(Spine: TopoDS_Wire, Join: GeomAbs_JoinType);
  /**
...
export declare class BRepBuilderAPI_Transform extends BRepBuilderAPI_ModifyShape {
   ...
   * Constructs a framework for applying the geometric transformation T to a shape. Use the function Perform to define the shape to transform.
   */
  constructor(theShape: TopoDS_Shape, theTrsf: gp_Trsf);
  /**
   * Constructs a framework for applying the geometric transformation T to a shape. Use the function Perform to define the shape to transform.
   */
...
export declare class BRepBuilderAPI_MakeShell extends BRepBuilderAPI_MakeShape {
   ...
   * Constructs an empty shell framework. The Init function is used to define the construction arguments. Warning The function Error will return BRepBuilderAPI_EmptyShell if it is called before the function Init.
   */
  constructor(S: Geom_Surface, UMin: number, UMax: number, VMin: number, VMax: number);
  /**
...
export declare class BRepLib {
   ...
   */
  static EncodeRegularity(S: TopoDS_Shape, LE: TopTools_ListOfShape, TolAng: number): void;
  /**
   ...
   * @param theFExtended The extended face
   */
...
export declare class BRepFilletAPI_MakeChamfer extends BRepFilletAPI_LocalOperation {
  ...
  Sect(IC: number, IS: number): ChFiDS_CircSection;
  /** Releases the C++ object. The caller must ensure no further access. */
  delete(): void;
  [Symbol.dispose](): void;
}
...
export declare class BRepFilletAPI_MakeFillet extends BRepFilletAPI_LocalOperation {
   ...
   */
  SetRadius(UandR: TColgp_Array1OfPnt2d, IC: number, IinC: number): void;
  /**
...
export declare class ShapeFix_Face extends ShapeFix_Root {
   ...
   */
  FixOrientation(MapWires: any): boolean;
  /**
...
export declare class ShapeUpgrade_UnifySameDomain extends Standard_Transient {
   ...
   * Empty constructor.
   */
  constructor(aShape: TopoDS_Shape, UnifyEdges: boolean);
  /**
   * Empty constructor.
   */
  constructor(aShape: TopoDS_Shape, UnifyEdges: boolean, UnifyFaces: boolean);
  /**
...
export declare class GeomAdaptor_TransformedSurface extends Adaptor3d_Surface {
   ...
   * Creates an undefined surface with identity transformation.
   */
  constructor(theSurface: Geom_Surface, theUFirst: number, theULast: number, theVFirst: number, theVLast: number, theTrsf: gp_Trsf);
  /**
   * Creates an undefined surface with identity transformation.
   */
  constructor(theSurface: Geom_Surface, theUFirst: number, theULast: number, theVFirst: number, theVLast: number, theTrsf: gp_Trsf, theTolU: number);
  /**
...
export declare class Geom_BSplineSurface extends Geom_BoundedSurface {
   ...
   */
  constructor(Poles: any, UKnots: TColStd_Array1OfReal, VKnots: TColStd_Array1OfReal, UMults: TColStd_Array1OfInteger, VMults: TColStd_Array1OfInteger, UDegree: number, VDegree: number);
  /**
   * Creates a non-rational b-spline surface (weights default value is 1.). The following conditions must be verified. 0 < UDegree <= MaxDegree. UKnots.Length() == UMults.Length() >= 2 UKnots(i) < UKnots(i+1) (Knots are increasing) 1 <= UMults(i) <= UDegree On a non uperiodic surface the first and last umultiplicities may be UDegree+1 (this is even recommended if you want the curve to start and finish on the first and last pole). On a uperiodic surface the first and the last umultiplicities must be the same. on non-uperiodic surfaces Poles.ColLength() == Sum(UMults(i)) - UDegree - 1 >= 2 on uperiodic surfaces Poles.ColLength() == Sum(UMults(i)) except the first or last The previous conditions for U holds also for V, with the RowLength of the poles.
   */
  constructor(Poles: any, UKnots: TColStd_Array1OfReal, VKnots: TColStd_Array1OfReal, UMults: TColStd_Array1OfInteger, VMults: TColStd_Array1OfInteger, UDegree: number, VDegree: number, UPeriodic: boolean);
  /**
   * Creates a non-rational b-spline surface (weights default value is 1.). The following conditions must be verified. 0 < UDegree <= MaxDegree. UKnots.Length() == UMults.Length() >= 2 UKnots(i) < UKnots(i+1) (Knots are increasing) 1 <= UMults(i) <= UDegree On a non uperiodic surface the first and last umultiplicities may be UDegree+1 (this is even recommended if you want the curve to start and finish on the first and last pole). On a uperiodic surface the first and the last umultiplicities must be the same. on non-uperiodic surfaces Poles.ColLength() == Sum(UMults(i)) - UDegree - 1 >= 2 on uperiodic surfaces Poles.ColLength() == Sum(UMults(i)) except the first or last The previous conditions for U holds also for V, with the RowLength of the poles.
   */
  constructor(Poles: any, Weights: any, UKnots: TColStd_Array1OfReal, VKnots: TColStd_Array1OfReal, UMults: TColStd_Array1OfInteger, VMults: TColStd_Array1OfInteger, UDegree: number, VDegree: number);
  /**
   * Creates a non-rational b-spline surface (weights default value is 1.). The following conditions must be verified. 0 < UDegree <= MaxDegree. UKnots.Length() == UMults.Length() >= 2 UKnots(i) < UKnots(i+1) (Knots are increasing) 1 <= UMults(i) <= UDegree On a non uperiodic surface the first and last umultiplicities may be UDegree+1 (this is even recommended if you want the curve to start and finish on the first and last pole). On a uperiodic surface the first and the last umultiplicities must be the same. on non-uperiodic surfaces Poles.ColLength() == Sum(UMults(i)) - UDegree - 1 >= 2 on uperiodic surfaces Poles.ColLength() == Sum(UMults(i)) except the first or last The previous conditions for U holds also for V, with the RowLength of the poles.
   */
  constructor(Poles: any, UKnots: TColStd_Array1OfReal, VKnots: TColStd_Array1OfReal, UMults: TColStd_Array1OfInteger, VMults: TColStd_Array1OfInteger, UDegree: number, VDegree: number, UPeriodic: boolean, VPeriodic: boolean);
  /**
   * Creates a non-rational b-spline surface (weights default value is 1.). The following conditions must be verified. 0 < UDegree <= MaxDegree. UKnots.Length() == UMults.Length() >= 2 UKnots(i) < UKnots(i+1) (Knots are increasing) 1 <= UMults(i) <= UDegree On a non uperiodic surface the first and last umultiplicities may be UDegree+1 (this is even recommended if you want the curve to start and finish on the first and last pole). On a uperiodic surface the first and the last umultiplicities must be the same. on non-uperiodic surfaces Poles.ColLength() == Sum(UMults(i)) - UDegree - 1 >= 2 on uperiodic surfaces Poles.ColLength() == Sum(UMults(i)) except the first or last The previous conditions for U holds also for V, with the RowLength of the poles.
   */
  constructor(Poles: any, Weights: any, UKnots: TColStd_Array1OfReal, VKnots: TColStd_Array1OfReal, UMults: TColStd_Array1OfInteger, VMults: TColStd_Array1OfInteger, UDegree: number, VDegree: number, UPeriodic: boolean);
  /**
   * Creates a non-rational b-spline surface (weights default value is 1.).
   */
  constructor(Poles: any, Weights: any, UKnots: TColStd_Array1OfReal, VKnots: TColStd_Array1OfReal, UMults: TColStd_Array1OfInteger, VMults: TColStd_Array1OfInteger, UDegree: number, VDegree: number, UPeriodic?: boolean, VPeriodic?: boolean);
  /**
   ...
   */
  SetPoleCol(VIndex: number, CPoles: TColgp_Array1OfPnt): void;
  /**
   ...
   */
  SetPoleCol(VIndex: number, CPoles: TColgp_Array1OfPnt, CPoleWeights: TColStd_Array1OfReal): void;
  /**
   ...
   */
  SetPoleRow(UIndex: number, CPoles: TColgp_Array1OfPnt, CPoleWeights: TColStd_Array1OfReal): void;
  /**
   * Changes a row of poles or a part of this row. Raised if Uindex < 1 or UIndex > NbUPoles.
   */
  SetPoleRow(UIndex: number, CPoles: TColgp_Array1OfPnt): void;
  /**
   ...
   * @deprecated
   */
  UKnots(Ku: TColStd_Array1OfReal): void;
  /**
   * Returns the knots in the U direction.
   */
   ...
   * @deprecated
   */
  UKnotSequence(Ku: TColStd_Array1OfReal): void;
  /**
   * Returns the uknots sequence. In this sequence the knots with a multiplicity greater than 1 are repeated. Example : Ku = {k1, k1, k1, k2, k3, k3, k4, k4, k4}.
   */
  UKnotSequence(): TColStd_Array1OfReal;
  /**
   ...
   * @deprecated
   */
  UMultiplicities(Mu: TColStd_Array1OfInteger): void;
  /**
   * Returns the multiplicities of the knots in the U direction.
   */
  UMultiplicities(): TColStd_Array1OfInteger;
  /**
   ...
   * @deprecated
   */
  VKnots(Kv: TColStd_Array1OfReal): void;
  /**
   * Returns the knots in the V direction.
   */
   ...
   * @deprecated
   */
  VKnotSequence(Kv: TColStd_Array1OfReal): void;
  /**
   ...
   */
  VKnotSequence(): TColStd_Array1OfReal;
  /**
   ...
   * @deprecated
   */
  VMultiplicities(Mv: TColStd_Array1OfInteger): void;
  /**
   * Returns the multiplicities of the knots in the V direction.
   */
  VMultiplicities(): TColStd_Array1OfInteger;
  /**
...
export declare class Geom_BSplineCurve extends Geom_BoundedCurve {
   ...
   */
  constructor(Poles: TColgp_Array1OfPnt, Knots: TColStd_Array1OfReal, Multiplicities: TColStd_Array1OfInteger, Degree: number);
  /**
   * Creates a non-rational B_spline curve on the basis <Knots, Multiplicities> of degree <Degree>.
   */
   ...
   * Creates a non-rational B_spline curve on the basis <Knots, Multiplicities> of degree <Degree>.
   */
  constructor(Poles: TColgp_Array1OfPnt, Weights: TColStd_Array1OfReal, Knots: TColStd_Array1OfReal, Multiplicities: TColStd_Array1OfInteger, Degree: number);
  /**
   * Creates a non-rational B_spline curve on the basis <Knots, Multiplicities> of degree <Degree>.
   */
  constructor(Poles: TColgp_Array1OfPnt, Weights: TColStd_Array1OfReal, Knots: TColStd_Array1OfReal, Multiplicities: TColStd_Array1OfInteger, Degree: number, Periodic: boolean);
  /**
...
export declare class Geom2d_BSplineCurve extends Geom2d_BoundedCurve {
   ...
   */
  constructor(Poles: TColgp_Array1OfPnt2d, Knots: TColStd_Array1OfReal, Multiplicities: TColStd_Array1OfInteger, Degree: number);
  /**
   * Creates a non-rational B_spline curve on the basis <Knots, Multiplicities> of degree <Degree>. The following conditions must be verified. 0 < Degree <= MaxDegree.
   */
   ...
   * Creates a non-rational B_spline curve on the basis <Knots, Multiplicities> of degree <Degree>. The following conditions must be verified. 0 < Degree <= MaxDegree.
   */
  constructor(Poles: TColgp_Array1OfPnt2d, Weights: TColStd_Array1OfReal, Knots: TColStd_Array1OfReal, Multiplicities: TColStd_Array1OfInteger, Degree: number);
  /**
   ...
   * @deprecated
   */
  Poles(P: TColgp_Array1OfPnt2d): void;
  /**
   * Returns the poles of the B-spline curve;.
   */
...
export declare class Geom2dConvert_BSplineCurveToBezierCurve {
   ...
   */
  Arcs(Curves: Geom2d_BezierCurve): void;
  /**
...
export declare class GeomLib {
   ...
   * @param Confision tolerance to compare intervals
...
export declare class GCPnts_TangentialDeflection {
   ...
   * Empty constructor.
   */
  constructor(theC: Adaptor3d_Curve, theAngularDeflection: number, theCurvatureDeflection: number);
  /**
   * Empty constructor.
   */
  constructor(theC: Adaptor2d_Curve2d, theAngularDeflection: number, theCurvatureDeflection: number);
  /**
   * Empty constructor.
   */
  constructor(theC: Adaptor3d_Curve, theAngularDeflection: number, theCurvatureDeflection: number, theMinimumOfPoints: number);
  /**
   * Empty constructor.
   */
  constructor(theC: Adaptor2d_Curve2d, theAngularDeflection: number, theCurvatureDeflection: number, theMinimumOfPoints: number);
  /**
   * Empty constructor.
   */
  constructor(theC: Adaptor3d_Curve, theAngularDeflection: number, theCurvatureDeflection: number, theMinimumOfPoints: number, theUTol: number);
  /**
   * Empty constructor.
   */
  constructor(theC: Adaptor2d_Curve2d, theAngularDeflection: number, theCurvatureDeflection: number, theMinimumOfPoints: number, theUTol: number);
  /**
   * Empty constructor.
   */
  constructor(theC: Adaptor3d_Curve, theFirstParameter: number, theLastParameter: number, theAngularDeflection: number, theCurvatureDeflection: number);
  /**
   * Empty constructor.
   */
  constructor(theC: Adaptor2d_Curve2d, theFirstParameter: number, theLastParameter: number, theAngularDeflection: number, theCurvatureDeflection: number);
  /**
   ...
   * @param theMinLen minimal length
   */
  constructor(theC: Adaptor3d_Curve, theFirstParameter: number, theLastParameter: number, theAngularDeflection: number, theCurvatureDeflection: number, theMinimumOfPoints: number);
  /**
   * Constructor for 3D curve.
   * @param theC 3d curve
   * @param theAngularDeflection angular deflection in radians
   ...
   * @param theMinLen minimal length
   */
  constructor(theC: Adaptor2d_Curve2d, theFirstParameter: number, theLastParameter: number, theAngularDeflection: number, theCurvatureDeflection: number, theMinimumOfPoints: number);
  /**
   * Empty constructor.
   */
  constructor(theC: Adaptor3d_Curve, theFirstParameter: number, theLastParameter: number, theAngularDeflection: number, theCurvatureDeflection: number, theMinimumOfPoints: number, theUTol: number);
  /**
   * Empty constructor.
   */
  constructor(theC: Adaptor2d_Curve2d, theFirstParameter: number, theLastParameter: number, theAngularDeflection: number, theCurvatureDeflection: number, theMinimumOfPoints: number, theUTol: number);
  /**
...
export declare class BRep_Tool {
   ...
   */
  static Triangulations(theFace: TopoDS_Face, theLocation: TopLoc_Location): Poly_Triangulation;
  /**
...
export declare class Interface_Static extends Interface_TypedValue {
   ...
   */
  static Items(mode: number, criter: string): TCollection_HAsciiString;
  /**
...
export declare class XSControl_Reader {
   ...
   */
  GiveList_1(first: string, second: string): Standard_Transient;
  /**
   ...
   */
  GiveList_2(first: string, ent: Standard_Transient): Standard_Transient;
  /**
   ...
   */
  TransferList(list: Standard_Transient, theProgress: Message_ProgressRange): number;
  /**
   ...
   */
  SetShapeFixParameters(theParameters: any): void;
  /**
   * Sets parameters for shape processing.
   * @param theParameters the parameters for shape processing.
   */
   ...
   */
  SetShapeFixParameters(theParameters: DE_ShapeFixParameters, theAdditionalParameters: any): void;
  /**
...
export declare class IFSelect_WorkSession extends Standard_Transient {
   ...
   */
  Shareds(ent: Standard_Transient): Standard_Transient;
  /**
   * Returns the list of entities sharing <ent> (can be empty) Returns a null Handle if <ent> is unknown.
   */
  Sharings(ent: Standard_Transient): Standard_Transient;
  /**
   ...
   */
  ItemIdents(type: Standard_Type): number;
  /**
   ...
   */
  ItemNames(type: Standard_Type): TCollection_HAsciiString;
  /**
   ...
   */
  ItemNamesForLabel(label: string): TCollection_HAsciiString;
  /**
   ...
   */
  SelectionResult(sel: IFSelect_Selection): Standard_Transient;
  /**
   ...
   */
  SelectionResultFromList(sel: IFSelect_Selection, list: Standard_Transient): Standard_Transient;
  /**
   ...
   */
  ComputeCounterFromList(counter: IFSelect_SignCounter, list: Standard_Transient, clear: boolean): boolean;
  /**
   * Returns the ordered list of dispatches stored by the ShareOut.
   */
  AppliedDispatches(): number;
  /**
   ...
   */
  FinalModifierIdents(formodel: boolean): number;
  /**
   ...
   */
  SentFiles(): TCollection_HAsciiString;
  /**
   ...
   */
  NewSelectPointed(list: Standard_Transient, name: string): IFSelect_Selection;
  /**
   ...
   */
  SetSelectPointed(sel: IFSelect_Selection, list: Standard_Transient, mode: number): boolean;
  /**
   ...
   */
  GiveList(obj: Standard_Transient): Standard_Transient;
  /**
   ...
   */
  GiveList(first: string, second: string): Standard_Transient;
  /**
   ...
   */
  GiveListFromList(selname: string, ent: Standard_Transient): Standard_Transient;
  /**
   ...
   */
  GiveListCombined(l1: Standard_Transient, l2: Standard_Transient, mode: number): Standard_Transient;
  /**
...
export declare class STEPCAFControl_Writer {
   ...
   */
  Transfer_5(theLabelSeq: TDF_Label, theMode: STEPControl_StepModelType, theIsMulti: string, theProgress: Message_ProgressRange): boolean;
  /**
   ...
   */
  Transfer_6(theLabelSeq: TDF_Label, theParams: DESTEP_Parameters, theMode: STEPControl_StepModelType, theIsMulti: string, theProgress: Message_ProgressRange): boolean;
...
export declare class XCAFDoc_ShapeTool extends TDataStd_GenericEmpty {
   ...
   */
  static GetOneShape(theLabels: TDF_Label): TopoDS_Shape;
  /**
   ...
   */
  static GetComponents(L: TDF_Label, Labels: TDF_Label, getsubchilds: boolean): boolean;
  /**
   ...
   */
  static GetSubShapes(L: TDF_Label, Labels: TDF_Label): boolean;
  /**
   ...
   */
  SetExternRefs(SHAS: TCollection_HAsciiString): TDF_Label;
  /**
   * Sets the names of references on the no-step files.
   */
  SetExternRefs(L: TDF_Label, SHAS: TCollection_HAsciiString): void;
  /**
   * Gets the names of references on the no-step files.
   */
  static GetExternRefs(L: TDF_Label, SHAS: TCollection_HAsciiString): void;
  /**
   ...
   */
  static GetAllComponentSHUO(CompLabel: TDF_Label, SHUOAttrs: TDF_Attribute): boolean;
  /**
   ...
   */
  static GetSHUOUpperUsage(NextUsageL: TDF_Label, Labels: TDF_Label): boolean;
  /**
   ...
   */
  static GetSHUONextUsage(UpperUsageL: TDF_Label, Labels: TDF_Label): boolean;
  /**
   ...
   */
  FindComponent(theShape: TopoDS_Shape, Labels: TDF_Label): boolean;
  /**
   ...
   * @param theRefLabel the reference label with new location
...
export declare class XCAFDoc_ColorTool extends TDataStd_GenericEmpty {
   ...
   */
  GetColors(Labels: TDF_Label): void;
  /**
...
export declare class Poly_Array1OfTriangle {
  ...
  constructor(theBegin: Poly_Triangle, theLower: number, theUpper: number);
...
export declare class TColgp_Array1OfPnt2d {
  ...
  constructor(theLower: number, theUpper: number);
  constructor(theBegin: gp_Pnt2d, theLower: number, theUpper: number);
...
export declare class TColStd_Array1OfBoolean {
  ...
  constructor(theLower: number, theUpper: number);
  constructor(theBegin: boolean, theLower: number, theUpper: number);
...
export declare class TColgp_Array1OfDir {
  ...
  constructor(theLower: number, theUpper: number);
  constructor(theBegin: gp_Dir, theLower: number, theUpper: number);
...
export declare class TColgp_Array1OfPnt {
  ...
  constructor(theLower: number, theUpper: number);
  constructor(theBegin: gp_Pnt, theLower: number, theUpper: number);
...
export declare class TColgp_Array1OfVec {
  ...
  constructor(theLower: number, theUpper: number);
  constructor(theBegin: gp_Vec, theLower: number, theUpper: number);
...
export namespace FairCurve {
  export type Batten_Compute = typeof FairCurve_Batten_Compute;
  export type MinimalVariation_Compute = typeof FairCurve_MinimalVariation_Compute;
}
...
export namespace Poly {
  export type Array1OfTriangle = Poly_Array1OfTriangle;
...
export namespace TColStd {
  export type Array1OfBoolean = TColStd_Array1OfBoolean;
  export type Array1OfInteger = TColStd_Array1OfInteger;
  export type Array1OfReal = TColStd_Array1OfReal;
  export type IndexedDataMapOfStringString = TColStd_IndexedDataMapOfStringString;
}

export namespace TColgp {
  export type Array1OfDir = TColgp_Array1OfDir;
  export type Array1OfPnt = TColgp_Array1OfPnt;
  export type Array1OfPnt2d = TColgp_Array1OfPnt2d;
  export type Array1OfVec = TColgp_Array1OfVec;
  export type Array2OfPnt = TColgp_Array2OfPnt;
}
...
export namespace TopTools {
  export type ListOfShape = TopTools_ListOfShape;
}
...
export type OpenCascadeInstance = {FS: typeof FS} & {
  ...
  OCJS: typeof OCJS;
  FairCurve_Batten_Compute: typeof FairCurve_Batten_Compute;
  FairCurve_MinimalVariation_Compute: typeof FairCurve_MinimalVariation_Compute;
